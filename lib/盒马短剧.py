...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result = {"class": [{"type_id": "53@精选", "type_name": "TAO🌠精选"},
                            {"type_id": "54@古装", "type_name": "TAO🌠古装"},
                            {"type_id": "55@重生", "type_name": "TAO🌠重生"},
                            {"type_id": "56@家庭", "type_name": "TAO🌠家庭"},
                            {"type_id": "57@恋爱", "type_name": "TAO🌠恋爱"}],
                 }
    ...
    def detailContent(self, ids):
        ...
        if response.status_code == 200:
            ...
            vod_content = 'TAO为您介绍剧情' + detail['videoInfo']['introduction']
